...
int lcdTopRow = 0;
int lcdBottomRow = 1;
int DropCount = 1;       // default Starting point
int pulseWidth0 = 90;    //Valve ON Time  (Drop Size)
int pulseWidth1 = 90;    //Valve ON Time  (Drop Size)
int pulseWidth2 = 90;    //Valve ON Time  (Drop Size)
int pulseSep0 = 90;      // Drop Seperation time  (Time Between Drops), valve off time
int pulseSep1 = 90;      // Drop Seperation time  (Time Between Drops), valve off time
...
int valveControl =2;    // Output pin to turn valve ON & OFF
...
void loop() 
{
//digitalWrite(valveControl,VLVOFF); 
...
//Serial.println("up pressed");
 ...
 if (cursorValue == 0)
 {
  ...
  // Serial.println(DropCount);
   ...
   else if (DropCount == 2  && cursorValue == 0)
...
*/
 digitalWrite(valveControl,VLVON);
 delay(pulseWidth0);
 digitalWrite(valveControl,VLVOFF);
